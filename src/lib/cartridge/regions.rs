pub const DEFAULT_RAM_BANK: u8 = 0x00;
// const DEFAULT_ROM_BANK: u8 = 0x01;

pub const RAM_ENABLE_START: u16 = 0x0000;
pub const RAM_ENABLE_END: u16 = 0x1FFF;
pub const ROM_BANK_SEL_START: u16 = 0x2000;
pub const ROM_BANK_SEL_END: u16 = 0x3FFF;
pub const RAM_BANK_SEL_START: u16 = 0x4000;
pub const RAM_BANK_SEL_END: u16 = 0x5FFF;
pub const BANK_MODE_START: u16 = 0x6000;
pub const BANK_MODE_END: u16 = 0x7FFF;

pub const ERAM_SIZE: usize = 32 * 1024;
pub const ROM_REGION_BANK0_START: u16 = ROM_REGION_START;
pub const ROM_REGION_BANK0_END: u16 = 0x3FFF;
pub const ROM_REGION_BANKN_START: u16 = 0x4000;
pub const ROM_REGION_BANKN_END: u16 = ROM_REGION_END;
